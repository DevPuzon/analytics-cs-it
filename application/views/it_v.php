...
<input type="hidden" id="txtCourseType" value="it">
<div class="row">
	<div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" data="req" data-key="selStatus">
								<option value = ''></option>
								<?php
			...
			<div class="card-header">
				...
				<div class="d-flex justify-content-between">
					...
					<div class="pull-right box-tools">
						<button type="button" class="btn btn-sm btn-outline-primary" data-trigger="add-it">
							<i class="fa fa-user-plus"></i> Add Student
						</button>
						<button type="button" class="btn btn-sm btn-outline-danger" data-trigger="print-it">
    	...
    	<div class="modal-dialog modal-lg">
        	<div class="modal-content">
      			...
      			<div class="modal-footer justify-content-between">
	              	...
	              	<button type="button" class="btn btn-outline-primary" data-trigger="save-it">
